...
use Booka\Core\Helpers\Filesystem;
...
class FilesystemTest extends Unit
{
    ...
    public function testCreateDirectory()
    {
        ...
        $success = Filesystem::createDirectory('cache/bla');
        static::assertIsBool($success);
        static::assertTrue($success);
        static::assertTrue(file_exists('cache/bla'));

        // create directory outside of rights
        static::expectException('PHPUnit\Framework\Exception');
        Filesystem::createDirectory('/somewhere');
    }
}
